...
function Stake() {
  ...
  const onChangeStake = async (action, isOld) => {
    ...
    if (action === "stake" && gweiValue.gt(ethers.utils.parseUnits(bhdBalance, "gwei"))) {
      return dispatch(error("You cannot stake more than your EVER balance."));
    }

    if (action === "unstake" && gweiValue.gt(ethers.utils.parseUnits(unstakedVal, "gwei"))) {
      return dispatch(error("You cannot unstake more than your sEVER balance."));
    }
    await dispatch(
      changeStake({
        address,
                ...
                <div className="card-header">
                  ...
                  {address && oldsbhdBalance > 0.01 && (
                    ...
                    >
                      ...
                      <Typography>Migrate sEVER!</Typography>
                    </Link>
                  )}
                </div>
              </Grid>
                  ...
                  <Grid container spacing={2} alignItems="flex-end">
                    ...
                    <Grid item xs={12} sm={4} md={4} lg={4}>
                      <div className="stake-index">
                        ...
                        <Typography variant="h4">
                          {currentIndex ? <>{trim(currentIndex, 1)} EVER</> : <Skeleton width="150px" />}
                        </Typography>
                      </div>
                    </Grid>
                  </Grid>
              ...
              <div className="staking-area">
                {!address ? (
                  <div className="stake-wallet-notification">
                    ...
                    <Typography variant="h6">Connect your wallet to stake EVER</Typography>
                  </div>
                ) : (
                  <>
                      ...
                      <Box className="stake-action-row " display="flex" alignItems="center">
                          ...
                          (!hasAllowance("bhd") && view === 0) || (!hasAllowance("sbhd") && view === 1) ? (
                            <Box className="help-text">
                              <Typography variant="body1" className="stake-note" color="textSecondary">
                                {view === 0 ? (
                                  <>
                                    First time staking <b>EVER</b>?
                                    <br />
                                    Please approve Everlast DAO to use your <b>EVER</b> for staking.
                                  </>
                                ) : (
                                  <>
                                    First time unstaking <b>sEVER</b>?
                                    <br />
                                    Please approve Everlast DAO to use your <b>sEVER</b> for unstaking.
                                  </>
                                )}
                              </Typography>
                            </Box>
                        ...
                        <TabPanel value={view} index={0} className="stake-tab-panel">
                          {isAllowanceDataLoading ? (
                            ...
                            >
                              {txnButtonText(pendingTransactions, "staking", "Stake EVER")}
                            </Button>
                          ) : (
                            <Button
                              className="stake-button"
                        ...
                        <TabPanel value={view} index={1} className="stake-tab-panel">
                          {isAllowanceDataLoading ? (
                            ...
                            >
                              {txnButtonText(pendingTransactions, "unstaking", "Unstake EVER")}
                            </Button>
                          ) : (
                            <Button
                              className="stake-button"
                    ...
                    <div className={`stake-user-data`}>
                      <div className="data-row">
                        ...
                        <Typography variant="body1">
                          {isAppLoading ? <Skeleton width="80px" /> : <>{trim(bhdBalance, 4)} EVER</>}
                        </Typography>
                      </div>
                      ...
                      <div className="data-row">
                        ...
                        <Typography variant="body1">
                          {isAppLoading ? <Skeleton width="80px" /> : <>{trimmedBalance} sEVER</>}
                        </Typography>
                      </div>
                      ...
                      <div className="data-row">
                        ...
                        <Typography variant="body1">
                          {isAppLoading ? <Skeleton width="80px" /> : <>{nextRewardValue} sEVER</>}
                        </Typography>
                      </div>
