      ...
      <Paper className="ohm-card">
          ...
          <>
            <Box display="flex" flexDirection="column" className="user-pool-data">
              ...
              <div className="data-row">
                ...
                <Typography>{props.isAccountLoading ? <Skeleton width={100} /> : props.sbhdBalance} sEVER</Typography>
              </div>
            </Box>
        ...
        <Box display="flex" flexDirection="column" className="pool-data">
          ...
          <div className="data-row">
            ...
            <Typography>
              {props.graphLoading ? <Skeleton width={100} /> : props.totalDeposits.toLocaleString()} sEVER
            </Typography>
          </div>
          <div className="data-row">
            <Typography>Total Sponsorship</Typography>
            <Typography>
              {props.graphLoading ? <Skeleton width={100} /> : props.totalSponsorship.toLocaleString()} sEVER
            </Typography>
          </div>
          <div className="data-row">
            <Typography>Yield Source</Typography>
            <Typography>sEVER</Typography>
          </div>
          <div className="data-row">
            <Typography>Pool owner</Typography>
            <Box display="flex" alignItems="center">
              <Typography>Everlast DAO</Typography>
            </Box>
          </div>
          <Divider color="secondary" />
          <div className="data-row">
        ...
        <div className="data-row-centered">
          <div className="marginedBtn">
            <Button variant="outlined" color="secondary" href={poolTogetherUILinks(chainID)[0]} target="_blank">
              <Typography variant="body1">sEVER Prize Pool&nbsp;</Typography>
              <SvgIcon component={ArrowUp} color="primary" />
            </Button>
          </div>
          <div className="marginedBtn">
            <Button variant="outlined" color="secondary" href={poolTogetherUILinks(chainID)[1]} target="_blank">
              <Typography variant="body1">sEVER Pool Details&nbsp;</Typography>
              <SvgIcon component={ArrowUp} color="primary" />
            </Button>
          </div>
        </div>
