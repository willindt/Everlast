...
function Claim() {
  ...
  const onChangeClaim = async action => {
    ...
    if (action === "claim" && gweiValue.gt(ethers.utils.parseUnits(pbhdBalance, "gwei"))) {
      return dispatch(error("You cannot claim more than your pEVER balance."));
    }
            ...
            <Grid container spacing={1} alignItems="center" justifyContent="center">
                ...
                !hasAllowance("pbhd") ? (
                  <Box className="help-text">
                    <Typography variant="body1" className="stake-note" color="textSecondary">
                      <>
                        First time use <b>pEVER</b>?
                        <br />
                        Please approve Everlast Dao to use your <b>pEVER</b> for claim EVER.
                      </>
                    </Typography>
                  </Box>
                ) : (
              ...
              {isAllowanceDataLoading ? (
                ...
                <Grid item xs={12} sm={4} md={4} lg={4}>
                  ...
                  >
                    {txnButtonText(pendingTransactions, "claim", "Claim EVER")}
                  </Button>
                </Grid>
              ) : (
