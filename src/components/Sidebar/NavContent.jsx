...
import { ReactComponent as EverlastIcon } from "../../assets/icons/bighead-nav-header.svg";
  ...
  return (
    <Paper className="dapp-sidebar">
      <Box className="dapp-sidebar-inner" display="flex" justifyContent="space-between" flexDirection="column">
        <div className="dapp-menu-top">
          <Box className="branding-header" style={{height: "250px"}}>
            <Link href="/" target="_blank">
              {/* <SvgIcon
                color="primary"
                component={EverlastIcon}
                viewBox="0 0 400 400"
                style={{ minWdth: "80px", minHeight: "300px", width: "300px" }}
              /> */}
              <Typography variant="h2" style={{paddingTop: "16px", paddingBottom: "16px"}}>Logo</Typography>
              <Typography variant="h3" style={{paddingTop: "16px", paddingBottom: "16px"}}>EVERLAST</Typography>
            </Link>
            {address && (
        ...
        <Box className="dapp-menu-bottom" justifyContent="space-between">
