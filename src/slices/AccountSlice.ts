...
import { abi as sEVER } from "../abi/sEVER.json";
import { abi as pEVER } from "../abi/pEVER.json";
...
export const getBalances = createAsyncThunk(
  ...
  async ({ address, networkID, provider }: IBaseAddressAsyncThunk) => {
    ...
    const sbhdContract = new ethers.Contract(addresses[networkID].SBHD_ADDRESS as string, sEVER, provider);
...
export const loadAccountDetails = createAsyncThunk(
  ...
  async ({ networkID, provider, address }: IBaseAddressAsyncThunk) => {
    ...
    const pbhdContract = new ethers.Contract(addresses[networkID].PBHD_ADDRESS as string, pEVER, provider);
    ...
    if (addresses[networkID].PBHD_ADDRESS) {
