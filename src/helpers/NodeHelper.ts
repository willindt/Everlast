...
export class NodeHelper {
  ...
  static getNodesUris = () => {
    ...
    let allURIs = ["https://speedy-nodes-nyc.moralis.io/a3fdf311d3d82a9d4be805d3/bsc/mainnet"];
    // let allURIs = ["https://bsc-dataseed.binance.org"];
    return allURIs;
  };

  static getTestNodeUris = () => {
    let allURIs = ["https://speedy-nodes-nyc.moralis.io/a3fdf311d3d82a9d4be805d3/bsc/testnet"];
    // let allURIs = ["https://bsc-dataseed.binance.org"];
    return allURIs;
  };
